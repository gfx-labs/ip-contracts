...
async function main() {
    ...
    writeFileSync(`rewardtree/mergedAndFormatWeek35.json`, JSON.stringify(valueAdjusted), 'utf8')
    writeFileSync(`rewardtree/week35Object.json`, JSON.stringify(formatObject), 'utf8')
