...
const LPS = require('../rewardtree/lenders_16849069-16899469')
const BORROWERS = require('../rewardtree/borrowers_16849069-16899469')
...
async function main() {
    ...
    writeFileSync(`rewardtree/mergedAndFormatWeek39.json`, JSON.stringify(valueAdjusted), 'utf8')
    writeFileSync(`rewardtree/week39Object.json`, JSON.stringify(formatObject), 'utf8')
