...
const LPS = require('../rewardtree/lps_15409840-15454640.json')
const BORROWERS = require('../rewardtree/borrowers_15409840-15454640.json')
...
async function main() {
    ...
    writeFileSync(`rewardtree/mergedAndFormatWeek10.json`, JSON.stringify(valueAdjusted), 'utf8')
    writeFileSync(`rewardtree/week10Object.json`, JSON.stringify(formatObject), 'utf8')
