...
async function main() {
    ...
    writeFileSync(`rewardtree/mergedAndFormatWeek41.json`, JSON.stringify(valueAdjusted), 'utf8')
    writeFileSync(`rewardtree/week41Object.json`, JSON.stringify(formatObject), 'utf8')
