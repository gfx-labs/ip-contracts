...
const LPS = require('../rewardtree/lps_15841049-15891449.json')
const BORROWERS = require('../rewardtree/borrowers_15841049-15891449.json')
...
async function main() {
    ...
    writeFileSync(`rewardtree/mergedAndFormatWeek19.json`, JSON.stringify(valueAdjusted), 'utf8')
    writeFileSync(`rewardtree/week19Object.json`, JSON.stringify(formatObject), 'utf8')
