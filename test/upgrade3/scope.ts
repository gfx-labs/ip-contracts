...
import { USDI, IERC20, IVOTE, InterestProtocolTokenDelegate, GovernorCharlieDelegate, AnchoredViewRelay, ChainlinkOracleRelay, IOracleRelay, IGovernorCharlieDelegator, ThreeLines0_100, IVault, IOracleMaster, IVaultController, ProxyAdmin, IUSDI, ICurveMaster } from "../../typechain-types";
