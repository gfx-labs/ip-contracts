...
const BNB_WHALE = "0xf2549FBA1DA6E17a1e82478A0b0a945aDB7416c7"
...
describe("hardhat settings", () => {
    it("Set hardhat network to a block after deployment", async () => {
        expect(await reset(17082947)).to.not.throw;
    });
...
describe("Initial Setup - BNB", () => {
    ...
    it("Connect to existing contracts", async () => {
        ...
        s.BNB = IERC20__factory.connect("0xB8c77482e45F1F44dE1745F52C74426C631bDD52", s.Frank)
    ...
    it("Should succesfully transfer money", async () => {
        ...
        await stealMoney(BNB_WHALE, s.Bob.address, s.BNB.address, s.BNB_AMOUNT)
        await stealMoney(BNB_WHALE, s.Carol.address, s.BNB.address, s.BNB_AMOUNT)
        await stealMoney(BNB_WHALE, s.Gus.address, s.BNB.address, s.BNB_AMOUNT)
