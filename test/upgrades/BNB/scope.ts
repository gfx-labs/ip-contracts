...
export class TestScope extends MainnetAddresses {
    ...
    BNB!: IERC20;
    BNB_AMOUNT = BN("1000e18")
    CappedBNB!: CappedGovToken
    BNB_CAP = BN("10000e18")
    BNB_LiqInc = BN("7500000000000000")//0.0075 / 0.75%
    BNB_LTV = BN("75e16")
    ...
    ChainBNBEth!: ChainBNBOracleRelay
    ChainBNBComp!: ChainBNBOracleRelay
    ChainBNBUni!: ChainBNBOracleRelay
    ChainBNBBtc!: ChainBNBOracleRelay
